                                ...
                                <?php if(isset($nama)) :?>
                                    <div class="card shadow mb-4">
                                        ...
                                        <!-- <div class="card-body text-gray-900"> -->
                                            ...
                                            <p>
                                                Telah menyelesaikan kursus TOEFL Intensive selama satu bulan di TOEFL Warrior dengan hasil sebagai berikut : 
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                Tgl Menyelesaikan Kursus : <?= tgl_indo($tgl_tes)?><br>
                                            </p>
                                            <p><small class="text-danger"><i>Catatan : Data diatas adalah hasil yang diambil dari tugas akhir yang tingkatnya setara dengan real test TOEFL. Data tersebut merupakan data peserta kursus TOEFL Intensive yang sebenar-benarnya dengan tidak ada pengurangan maupun penambahan nilai sedikitpun.</i></small></p>
                                        </div>
                                    </div>
                                <?php else :?>
                                    <div class="card shadow mb-4">
